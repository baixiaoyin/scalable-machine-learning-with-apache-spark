...
airbnb_df.write.format("delta").mode("overwrite").partitionBy("neighbourhood_cleansed").option("overwriteSchema", "true").save(f"{DA.paths.working_dir}/xy_test/")
...
airbnb_df.write.format("delta").mode("overwrite").save(f"{DA.paths.working_dir}")
